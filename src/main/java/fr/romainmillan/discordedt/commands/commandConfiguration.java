        ...
        if(e.getName().equals("configuration")){
            ...
            if(e.getMember().getRoles().contains(sudo)){
                ...
                if(configuration == null){
                    ...
                    Logger.getInstance().toLog(PluginName.CONF.getMessage(),  ConfigurationMessages.NO_GROUP_FIND.getMessages(), e.getGuild(), e.getMember(), false);
                    return;
                }
                ...
                if(action.equals("nick")){
                    ...
                    Logger.getInstance().toLog(PluginName.CONF.getMessage(), LoggerMessages.COMMAND_NOT_EXIST.getMessage(), e.getGuild(), e.getMember(), false);
                    return;
                }
                ...
                Logger.getInstance().toLog(PluginName.CONF.getMessage(), "Configuration `"+groupe+"` mise à jour", e.getGuild(), e.getMember(), true);
                return;
            }else {
